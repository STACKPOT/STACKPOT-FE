...
import { appealIconStyle, backgroundStyle, bodyContainer, bodyTitleContainer, bodyTitleIconStyle, bodyTitleStyle, closeButtonContainer, closeIconStyle, dateContainer, dateStyle, dividerStyle, introductionContentStyle, modalStyle, textAreaStyle, titleContainer, titleStyle } from "./AppealModal.style";
