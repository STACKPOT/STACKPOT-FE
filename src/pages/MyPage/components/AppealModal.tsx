...
import { appealIconStyle, backgroundStyle, bodyContainer, bodyTitleContainer, bodyTitleIconStyle, bodyTitleStyle, buttonStyle, closeButtonContainer, closeIconStyle, container, dateContainer, dateStyle, dividerStyle, introductionContentStyle, modalStyle, textAreaStyle, titleContainer, titleStyle } from "./AppealModal.style";
