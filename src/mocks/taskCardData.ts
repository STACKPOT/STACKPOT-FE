...
const taskCardkData = [
  {
    ...
    tag: "디자인",
    contributors: [
      { profileImage: MushRoomProfile, nickname: "자전거 타는 브로콜리" },
      { profileImage: CarrotProfile, nickname: "웃는 당근" },
      { profileImage: BroccoliProfile, nickname: "성실한 브로콜리" },
      { profileImage: MushRoomProfile, nickname: "자전거 타는 브로콜리" },
      { profileImage: CarrotProfile, nickname: "웃는 당근" },
      { profileImage: BroccoliProfile, nickname: "성실한 브로콜리" },
    ],
  },
  {
    ...
    nickname: "웃는 당근",
    groupProfileImages: [MushRoomProfile, CarrotProfile, BroccoliProfile],
  ...
  },
  {
    ...
    nickname: "성실한 양파",
    groupProfileImages: [MushRoomProfile, BroccoliProfile, OnionProfile],
    status: "진행 전" as const,
    tag: "라이브러리",
    contributors: [
      { profileImage: OnionProfile, nickname: "성실한 양파" },
      { profileImage: BroccoliProfile, nickname: "부지런한 브로콜리" },
    ],
  },
  {
    id: "4",
    ...
    profileImage: CarrotProfile,
    nickname: "웃는 당근",
    groupProfileImages: [CarrotProfile, BroccoliProfile],
    status: "완료" as const,
    tag: "문서 작업",
    contributors: [
      { profileImage: CarrotProfile, nickname: "웃는 당근" },
  ...
  },
  {
    ...
    nickname: "부지런한 브로콜리",
    groupProfileImages: [MushRoomProfile, CarrotProfile],
    status: "완료" as const,
    tag: "기록",
    contributors: [
      { profileImage: BroccoliProfile, nickname: "부지런한 브로콜리" },
  ...
  },
  {
    ...
    profileImage: MushRoomProfile,
    nickname: "자전거 타는 브로콜리",
    groupProfileImages: [MushRoomProfile, CarrotProfile, OnionProfile],
    status: "진행 중" as const,
    tag: "설계",
    contributors: [
      { profileImage: MushRoomProfile, nickname: "자전거 타는 브로콜리" },
  ...
  },
  {
    ...
    tag: "테스트",
    contributors: [
      { profileImage: MushRoomProfile, nickname: "테스트 브로콜리" },
    ],
  },
  {
    id: "8",
    ...
    tag: "빈 데이터",
    contributors: [
      { profileImage: OnionProfile, nickname: "테스트 양파" },
    ],
  },
];
